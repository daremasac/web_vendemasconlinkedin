...
<head>
    ...
    <title>Contacto - Conecta con Martín Cerro | Vende más con LinkedIn</title>
    <!-- Metadatos -->
    <meta name="author" content="<?php echo AUTHOR?>">
    <meta name="description" content="Conecta con Martín Cerro para potenciar tus ventas en LinkedIn. Descubre estrategias efectivas y maximiza tu éxito en la plataforma profesional.">
    <meta name="keywords" content="contacto, Martín Cerro, LinkedIn, ventas, estrategias de ventas, vender más, éxito en LinkedIn, marketing digital, red profesional, generar leads, networking, asesoría ventas">
    <!-- Etiquetas Open Graph -->
    <meta property="og:title" content="Contacto - Conecta con Martín Cerro | Vende más con LinkedIn" />
    <meta property="og:description" content="Conecta con Martín Cerro para potenciar tus ventas en LinkedIn. Descubre estrategias efectivas y maximiza tu éxito en la plataforma profesional.">
    <meta property="og:image" content="<?php echo URL?>assets/img/logo/miniatura.png">
    <meta property="og:url" content="<?php echo URL?>contacto" />
