...
<head>
    ...
    <!-- página 404 CSS -->
    <link rel="stylesheet" href="<?php echo URL?>assets/css/404.css">
    <!-- gsap -->
...
Cómo llegó hasta aquí es un misterio. Sin embargo, puede hacer clic en el botón a continuación para regresar a la página de inicio.
                    </p>
                    <a class="btn mb-5" href="<?php echo URL?>">Inicio</a>
                </div>
            </div>
        </div>
    </main>
    ...
    <!-- 404 -->
    <script src="<?php echo URL?>assets/js/404.js"></script>
</body>
