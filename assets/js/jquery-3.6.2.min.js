...
!(function (e, t) {
    ...
    function se(e, t, r, i) {
      ...
      if (!i && (p(t), (t = t || d), g)) {
        ...
        if (
          ...
          try {
            if (n.cssSupportsSelector && !CSS.supports("selector(" + y + ")"))
              throw new Error();
  ...
  (w.filter = function (e, t, n) {
    ...
    w.fn.extend({
      ...
      is: function (e) {
        return !!j(this, "string" == typeof e && k.test(e) ? w(e) : e || [], !1)
          .length;
      },
    });
  var D,
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          l = e.style;
        if (
          (u || (t = Ve(s)), (a = w.cssHooks[t] || w.cssHooks[s]), void 0 === n)
        )
    ...
    w.fn.extend({
      addClass: function (e) {
        ...
        return h(e)
          ...
          ? this.each(function () {
              if (
                ((r = yt(this)), (n = 1 === this.nodeType && " " + vt(r) + " "))
              ) {
          ...
          : ((n = mt(e)),
            this.each(function () {
              if (s)
                ...
                (void 0 !== e && "boolean" !== a) ||
                  ((r = yt(this)) && Y.set(this, "__className__", r),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
      ...
      ajax: function (t, n) {
        ...
        d.hasContent
          ...
          : ((p = d.url.slice(i.length)),
            ...
            !1 === d.cache &&
              ((i = i.replace(Lt, "$1")),
              (p = (St.test(i) ? "&" : "?") + "_=" + Ct.guid++ + p)),
            (d.url = i + p)),
        d.ifModified &&
          (w.lastModified[i] &&
            S.setRequestHeader("If-Modified-Since", w.lastModified[i]),
          w.etag[i] && S.setRequestHeader("If-None-Match", w.etag[i])),
            ...
            f
              ? (d.ifModified &&
                  ((T = S.getResponseHeader("Last-Modified")) &&
                    (w.lastModified[i] = T),
                  (T = S.getResponseHeader("etag")) && (w.etag[i] = T)),
                204 === t || "HEAD" === d.type
                  ? (C = "nocontent")
                  : 304 === t
                  ? (C = "notmodified")
